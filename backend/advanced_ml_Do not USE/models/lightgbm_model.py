...
class LightGBMModel:
    ...
    def __init__(self, model_path: str = "backend/data/ml_models/lightgbm", use_gpu: bool = True):
        """
        ...
        self.hyperparameters = {
            ...
            'n_estimators': 300,
            # NOTE: early_stopping_round requires eval_set, only used when validate=True
    ...
    def predict(self, features: Dict[str, float]) -> Dict[str, Any]:
        ...
        return format_prediction(probabilities, prediction_class, 'lightgbm')
    ...
    def predict_batch(self, feature_list: List[Dict[str, float]]) -> List[Dict[str, Any]]:
        ...
        for i in range(len(predictions)):
            ...
            # Use unified prediction layer
            result = format_prediction(probs, pred_class, 'lightgbm')
