...
THRESHOLDS: ±5% swing trade thresholds (BUY >= +5%, SELL <= -5%)
...
class ProductionScanner:
    ...
    THRESHOLDS: ±5% swing trade thresholds
    ...
    def __init__(
        ...
        HORIZON: 14 Days | THRESHOLDS: ±5% (Swing Trade)
        ...
        logger.info(f"Horizon: 14 Days | Thresholds: ±5% (Swing Trade)")
    ...
    def open_new_position(
        ...
        sltp = calculate_adaptive_sltp(
            ...
            horizon='1d',  # Fixed: 1d horizon parameter (14-day swing model)
    ...
    def scan_all(self, max_signals_per_type: int = 100) -> Dict[str, List[Dict[str, Any]]]:
        ...
        logger.info("Horizon: 14 Days | Thresholds: ±5% (Swing Trade)")
