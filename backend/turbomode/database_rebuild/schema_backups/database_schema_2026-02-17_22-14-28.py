...
class TurboModeDB:
    ...
    def _init_schema(self):
        ...
        cursor.execute("""CREATE TABLE active_signals (
        ...
        cursor.execute("""CREATE TABLE feature_store (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    symbol TEXT NOT NULL,
    ...
    UNIQUE(symbol, timestamp)
        ...
        cursor.execute("""CREATE TABLE price_data (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    symbol TEXT NOT NULL,
    timestamp TEXT NOT NULL,
    ...
    UNIQUE(symbol, timestamp, timeframe)
        ...
        cursor.execute("""CREATE TABLE sector_stats (
                id INTEGER PRIMARY KEY AUTOINCREMENT,
                date TEXT NOT NULL,
        ...
        cursor.execute("""CREATE TABLE signal_history (
                id INTEGER PRIMARY KEY AUTOINCREMENT,
                symbol TEXT NOT NULL,
    ...
    created_at TEXT DEFAULT CURRENT_TIMESTAMP
        ...
        cursor.execute("""CREATE TABLE training_runs (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    ...
    created_at TEXT DEFAULT CURRENT_TIMESTAMP
        ...
        cursor.execute("""CREATE INDEX idx_active_signals_age ON active_signals(age_days)""")

        cursor.execute("""CREATE INDEX idx_active_signals_market_cap ON active_signals(market_cap)""")

        cursor.execute("""CREATE INDEX idx_active_signals_sector ON active_signals(sector)""")

        cursor.execute("""CREATE INDEX idx_active_signals_signal_type ON active_signals(signal_type)""")

        cursor.execute("""CREATE INDEX idx_active_signals_symbol ON active_signals(symbol)""")

        cursor.execute("""CREATE INDEX idx_history_exit_date ON signal_history(exit_date)""")

        cursor.execute("""CREATE INDEX idx_history_sector ON signal_history(sector)""")

        cursor.execute("""CREATE INDEX idx_history_symbol ON signal_history(symbol)""")

        cursor.execute("""CREATE INDEX idx_sector_stats_date ON sector_stats(date)""")

        cursor.execute("""CREATE INDEX idx_sector_stats_sector ON sector_stats(sector)""")
