"""
XGBoost Approx Model - Purified Version (NO StandardScaler)

Uses approximate tree method for faster training.
...
class XGBoostApproxModel:
    """
    XGBoost with approximate tree method for TurboMode.
    ...
    def __init__(self, model_path: str = None, use_gpu: bool = True):
        ...
        self.model_path = model_path or 'backend/data/turbomode_models/xgboost_approx'
        self.feature_names = []
    ...
    def save(self) -> None:
        ...
        print(f"[OK] XGBoost Approx model saved to {self.model_path}")
        print(f"   - model.json: XGBoost Approx model")
    ...
    def load(self) -> None:
        ...
        print(f"[OK] XGBoost Approx model loaded (NO scaler.pkl)")
