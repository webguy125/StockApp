"""
XGBoost Histogram Model - Purified Version (NO StandardScaler)

Uses histogram-based tree method optimized for GPU.
...
class XGBoostHistModel:
    """
    XGBoost with histogram-based tree method for TurboMode.
    ...
    def __init__(self, model_path: str = None, use_gpu: bool = True):
        ...
        self.model_path = model_path or 'backend/data/turbomode_models/xgboost_hist'
        self.feature_names = []
        ...
        self.hyperparameters = {
            ...
            'max_leaves': 63,
            'n_estimators': 350,
            'max_depth': 0,  # 0 means unlimited with max_leaves control
            'learning_rate': 0.04,
            'subsample': 0.85,
    ...
    def save(self) -> None:
        ...
        print(f"[OK] XGBoost Hist model saved to {self.model_path}")
        print(f"   - model.json: XGBoost Hist model")
    ...
    def load(self) -> None:
        ...
        print(f"[OK] XGBoost Hist model loaded (NO scaler.pkl)")
