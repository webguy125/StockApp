"""
XGBoost DART Model - Purified Version (NO StandardScaler)

Uses DART (Dropouts meet Multiple Additive Regression Trees) boosting.
...
class XGBoostDARTModel:
    """
    XGBoost with DART boosting for TurboMode.
    ...
    def __init__(self, model_path: str = None, use_gpu: bool = True):
        ...
        self.model_path = model_path or 'backend/data/turbomode_models/xgboost_dart'
        self.feature_names = []
    ...
    def save(self) -> None:
        ...
        print(f"[OK] XGBoost DART model saved to {self.model_path}")
        print(f"   - model.json: XGBoost DART model")
    ...
    def load(self) -> None:
        ...
        print(f"[OK] XGBoost DART model loaded (NO scaler.pkl)")
