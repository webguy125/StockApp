...
export class Timeframe1d {
  ...
  handleTickerUpdate(data) {
    ...
    console.log(`  ✅ [1D] Processing ticker update - price=${price}, volume=${volumeBTC}, data.length=${this.data.length}`);
    ...
    if (this.data.length > 0) {
      ...
      console.log(`  ⚠️ [1D] Chart not loaded yet, ticker stored for later`);
    }
  }
