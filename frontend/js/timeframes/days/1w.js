...
export class Timeframe1w {
  ...
  handleTickerUpdate(data) {
    ...
    console.log(`  ✅ [1W] Processing ticker update - price=${price}, volume=${volumeBTC}, data.length=${this.data.length}`);
    ...
    if (this.data.length > 0) {
      ...
      console.log(`  ⚠️ [1W] Chart not loaded yet, ticker stored for later`);
    }
  }
