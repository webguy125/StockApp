...
export class Timeframe1mo {
  ...
  handleTickerUpdate(data) {
    ...
    console.log(`  ✅ [1MO] Processing ticker update - price=${price}, volume=${volumeBTC}, data.length=${this.data.length}`);
    ...
    if (this.data.length > 0) {
      ...
      console.log(`  ⚠️ [1MO] Chart not loaded yet, ticker stored for later`);
    }
  }
